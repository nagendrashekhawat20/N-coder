...
<body>
    ...
    <main>
        ...
        <section class="Retail-Sector-hero service-hero">
            <div class="container">
                <div class="text-center hero-heading">
                    <h1>
                        Retail Sector
                    </h1>
                    <p>Nurturing immaculate shopping environments</p>
                </div>
            </div>
        </section>
        <!-- hero area end here -->
        ...
        <section class="mt-100 mb-100 bath-img">
            ...
            <div class="container">
                <img src="./assets/img/sector/Retail-Sector.png" alt="Image not found"
                ...
                <div class="row">
                    <div class="col-12 col-lg-6 col-md-6 d-flex align-items-center">
                        ...
                        <div class="rs-about-detail">
                            ...
                            <h2 class="mb-30">
                                Your Pathway to Clean<br> Retail Spaces
                            </h2>
                            <h4>
                                Ensuring a pristine clean retail experience
                            </h4>
                            <p class="mb-30">
                                Top Masters is your dedicated partner in maintaining a spotless and inviting shopping
                                environment. Our expert cleaning services enhance customer satisfaction and brand
                                loyalty.
                            </p>
                            <p>
                    ...
                    <div class="owl-carousel">
                        ...
                        <div>
                            <a href="./Commercial-Sector.php">
                                <div class="sector-img-block">
                                    <img src="./assets/img/sector/Commercial.png" alt="Image not found"
                                        class="img-fluid">
                                    <div class="sector-img-overlay"></div>
                                    <div class="sector-text">
                                        <h3>Commercial</h3>
                        ...
                        <div>
                            <a href="./Hospitality-Sector.php">
                                <div class="sector-img-block">
                                    <img src="./assets/img/sector/Hospitality.png" alt="Image not found"
                                        class="img-fluid">
                        ...
                        <div>
                            <a href="./Transportation-Sector.php">
                                <div class="sector-img-block">
                                    <img src="./assets/img/sector/Transportation.png" alt="Image not found"
                                        class="img-fluid">
                                    <div class="sector-img-overlay">
                                    </div>
                                    <div class="sector-text">
                        ...
                        <div>
                            <a href="./Education-Sector.php">
                                <div class="sector-img-block">
                                    <img src="./assets/img/sector/Education.png" alt="Image not found"
                                        class="img-fluid">
                                    <div class="sector-img-overlay">
                                    </div>
                                    <div class="sector-text">
                        ...
                        <div>
                            <a href="./Industrial-Sector.php">
                                <div class="sector-img-block">
                                    <img src="./assets/img/sector/Industrial.png" alt="Image not found"
                                        class="img-fluid">
                                    <div class="sector-img-overlay">
                                    </div>
                                    <div class="sector-text">
                        ...
                        <div>
                            <a href="./Child-Care-Sector.php">
                                <div class="sector-img-block">
                                    <img src="./assets/img/sector/Child Care.png" alt="Image not found"
                                        class="img-fluid">
                                    <div class="sector-img-overlay">
                                    </div>
                                    <div class="sector-text">
                        ...
                        <div>
                            <a href="./Health-Care-Sector.php">
                                <div class="sector-img-block">
                                    <img src="./assets/img/sector/Health Care.png" alt="Image not found"
                                        class="img-fluid">
                                    <div class="sector-img-overlay">
                                    </div>
                                    <div class="sector-text">
