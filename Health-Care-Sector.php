...
<head>
    ...
    <title>Health Care Sector</title>
...
<body>
    ...
    <main>
        ...
        <section class="Health-Care-hero service-hero">
            <div class="container">
                <div class="text-center hero-heading">
                    ...
                    <p>
                        Providing sterile environments for patient well-being
                    </p>
                </div>
            </div>
        </section>
        ...
        <section class="mt-100 mb-100 bath-img">
            ...
            <div class="container">
                <img src="./assets/img/sector/Health-Care-Sector.png" alt="Image not found" class="img-fluid position-relative">
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-12 col-lg-6 col-md-6 d-flex align-items-center">
                        ...
                        <div class="rs-about-detail">
                            ...
                            <h2 class="mb-30">
                                Care for your patients in a sterile & safe environment
                            </h2>
                            <h4>
                                Enhancing safety through immaculate hygiene
                            </h4>
                            <p class="mb-30">
                                We understand the critical role cleanliness plays in healthcare; our team is committed to maintaining your healthcare environment to the highest standards.
                            </p>
                            <p>
                            ...
                            <div class="container mt-50 mb-50">
                                <img src="./assets/img/sector/Health-Care-Sector.png" alt="Image not found" class="img-fluid bath-img-mobile">
                            </div>
                        </div>
                    </div>
