...
<body>
    ...
    <main>
        ...
        <section class="Industrial-Sector-hero service-hero">
            <div class="container">
                <div class="text-center hero-heading">
                    <h1>
                        Industrial Sector
                    </h1>
                    <p>Elevate Cleanliness and Efficiency in Your Industrial Facility</p>
                </div>
            </div>
        </section>
        <!-- hero area end here -->
        ...
        <section class="mt-100 mb-100 bath-img">
            ...
            <div class="container">
                <img src="./assets/img/sector/Industrial-Sector.png" alt="Image not found" class="img-fluid position-relative">
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-12 col-lg-6 col-md-6 d-flex align-items-center">
                        ...
                        <div class="rs-about-detail">
                            ...
                            <h2 class="mb-30">
                                Creating Pristine and <br> Productive Work Environments
                            </h2>
                            <h4>
                                Top-Grade Industrial Cleaning Solutions
                            </h4>
                            <p class="mb-30">
                                Our industrial sector cleaning services are designed to exceed expectations, ensuring that your facility is consistently clean and conducive to efficiency.
                            </p>
                            <p>
                            ...
                            <div class="container mt-50 mb-50">
                                <img src="./assets/img/sector/Industrial-Sector.png" alt="Image not found" class="img-fluid bath-img-mobile">
                            </div>
                        </div>
                    </div>
