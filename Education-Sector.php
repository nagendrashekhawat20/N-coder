...
<body>
    ...
    <main>
        ...
        <section class="Education-Sector-hero service-hero">
            <div class="container">
                <div class="text-center hero-heading">
                    <h1>
                        Education Sector
                    </h1>
                    <p>Where Clean Spaces Inspire Bright Minds</p>
                </div>
            </div>
        </section>
        <!-- hero area end here -->
        ...
        <section class="mt-100 mb-100 bath-img">
            ...
            <div class="container">
                <img src="./assets/img/sector/Education-Sector.png" alt="Image not found" class="img-fluid position-relative">
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-12 col-lg-6 col-md-6 d-flex align-items-center">
                        ...
                        <div class="rs-about-detail">
                            ...
                            <h2 class="mb-30">
                                Fostering a Healthy and<br> Clean Learning Environment
                            </h2>
                            <h4>
                                Clean, Safe, and Conducive to Learning
                            </h4>
                            <p class="mb-30">
                                Top Masters is your dedicated partner in creating a clean, safe, and inspiring learning
                                environment. Our expert cleaning services promote student well-being and academic
                                success.
                            </p>
                            <p>
                            ...
                            <div class="container mt-50 mb-50">
                                <img src="./assets/img/sector/Education-Sector.png" alt="Image not found" class="img-fluid bath-img-mobile">
                            </div>
                        </div>
                    </div>
