...
<body>
    ...
    <main>
        ...
        <section class="Commercial-hero service-hero">
            <div class="container">
                <div class="text-center hero-heading">
                    <h1>
                        Residential Cleaning
                    </h1>
                    <p>We clean while you excel</p>
                </div>
            </div>
        </section>
        <!-- hero area end here -->
        ...
        <section class="mt-100 mb-100 bath-img">
            ...
            <div class="container">
                <img src="./assets/img/service/meeting-ofc.png" alt="Image not found" class="img-fluid position-relative">
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-12 col-lg-6 col-md-6 d-flex align-items-center">
                        ...
                        <div class="rs-about-detail">
                            ...
                            <h2 class="mb-30">
                                Weave our magic to keep<br> the office fantastic
                            </h2>
                            <h4>
                                Seal the deal away from dust
                            </h4>
                            <p class="mb-30">
                                Elevate your meeting rooms, offices and workspaces with our expert cleaning touch,
                                stirring productivity and a positive work atmosphere.
                            </p>
                            <a href="" class="btn btn-about" data-bs-target="#modalContactForm" data-bs-toggle="modal">Get Quote</a>

                            <div class="container mt-50 mb-50">
                                <img src="./assets/img/service/meeting-ofc.png" alt="Image not found" class="img-fluid bath-img-mobile">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="detail-list-res p-4">
                            ...
                            <div>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-1">
                                        <p class="mb-0">
                                            Emptying of bins and replacement of liners, as required
                                        </p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-1">
                                        <p class="mb-0">
                                            Desks (where cleared) damp-wiped and disinfected
                                        </p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-1">
                                        <p class="mb-0">
                                            Ledges and horizontal surfaces (where cleared) damp-wiped and disinfected
                                        </p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-1">
                                        <p class="mb-0">
                                            Finger marks from light switches and glass entry doors and panels removed
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="mt-100 mb-100 kitch-img">
            ...
            <div class="container">
                <img src="./assets/img/service/cust-ofc.png" alt="Image not found" class="img-fluid">
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-12 col-lg-6 col-md-6 d-flex align-items-center">
                        ...
                        <div class="rs-about-detail">
                            ...
                            <h2 class="mb-30">
                                Make an ideal first<br> impression
                            </h2>
                            <h4>
                                Invite your customer into a happy place
                            </h4>
                            <p class="mb-30">
                                Give customer-facing areas the makeover they deserve with our sparkling cleaning
                                services. We dust off the dullness to reveal a vibrant, inviting portal.
                            </p>
                            <a href="" class="btn btn-about" data-bs-target="#modalContactForm" data-bs-toggle="modal">Get Quote</a>
                            <div class="container">
                                <img src="./assets/img/service/cust-ofc.png" alt="Image not found" class="img-fluid mt-50 mb-50 kitch-img-mobile">
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-6">
                    ...
                    <div>
                        <a href="" class="btn btn-about btn-quote-mobile mt-5 mx-5" data-bs-target="#modalContactForm" data-bs-toggle="modal">Get Quote</a>
                    </div>
                </div>
