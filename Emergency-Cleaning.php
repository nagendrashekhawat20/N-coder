...
<head>
    ...
    <title>Emergency Cleaning</title>
...
<body>
    ...
    <main>
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-6 align-items-center d-flex">
                        ...
                        <div class="banner-heading">
                            ...
                            <h1>
                                Rapid response emergency <br>
                                cleaning at your service
                            </h1>
                            <p>
                                Deal with the disaster swiftly
                            </p>
                        </div>
                        <div>
                    ...
                    <div class="col-12 col-sm-12 col-md-6">
                        <img src="./assets/img/service/Emergency-banner.png" alt="Image not found"
        ...
        <section class="mt-100 mb-100 bath-img">
            ...
            <div class="container">
                <img src="./assets/img/service/Emergency1.png" alt="Image not found"
                ...
                <div class="row">
                    <div class="col-12 col-lg-6 col-md-6 d-flex align-items-center">
                        ...
                        <div class="rs-about-detail">
                            ...
                            <h2 class="mb-30">
                                Reliable cleaning for<br> unexpected chaos
                            </h2>
                            <h4>
                                When calamity strikes, we clean it up
                            </h4>
                            <p class="mb-30">
                                We spring into action amidst chaos with efficiency and precision to promptly restore
                                order and cleanliness to your space. Count on us to tackle emergencies with expertise.
                            </p>
