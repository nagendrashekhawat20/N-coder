...
<body>
    ...
    <main>
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-6 align-items-center top-heading d-flex">
                        ...
                        <div class="container">
                            <div class="banner-heading">
                                ...
                                <h1>
                                    Revitalize your floors <br> with mastery!
                                </h1>
                                <p>
                                    From worn-out to wow in no time
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 p-0 banner-img">
                        ...
                        <div class="image-container">
                            <img src="./assets/img/service/strip-ban.png" alt="Image not found"
        ...
        <section class="mt-100 mb-100 bath-img">
            ...
            <div class="container">
                <img src="./assets/img/service/strip-1.png" alt="Image not found" class="img-fluid position-relative">
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-12 col-lg-6 col-md-6 d-flex align-items-center">
                        ...
                        <div class="rs-about-detail">
                            ...
                            <h2 class="mb-30">
                                A renewed shine, a<br> timeless touch!
                            </h2>
                            <h4>
                                Witness a floor transformation like never before
                            </h4>
                            <p class="mb-30">
                                Top Masters' strip and seal expertise meticulously clears away these layers,
                                reinvigorating the narrative of your flooring. With a renewed protective seal, we ensure
                                your floors not only speak but sparkle.
                            </p>
                            <a href="" data-bs-target="#modalContactForm" data-bs-toggle="modal" class="btn btn-about">Get Quote</a>

                            <div class="container mt-50 mb-50">
                                <img src="./assets/img/service/strip-1.png" alt="Image not found"
                        ...
                        <div class="detail-list-res p-4">
                            ...
                            <div>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-1">
                                        <p class="mb-0">
                                            Restored Beauty: Bring back the original allure and gloss of your flooring,
                                            making them look as pristine as when first installed.
                                        </p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-1">
                                        <p class="mb-0">
                                            Long-lasting Protection: Our sealing provides a robust protective layer
                                            against daily wear, spills, and scratches, ensuring longevity.
                                    </div>
                                </div>
                                <div class="d-flex align-items-center">
                                    <i class="fa fa-check-circle m-2"></i>
                                    ...
                                    <div class="ps-1">
                                        <p class="mb-0">
                                            Cost-effective Maintenance: Regular strip and seal services can reduce the
                                            need for expensive floor replacements in the future.
                                        </p>
                                        </p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-1">
                                        <p class="mb-0">
                                            Enhanced Safety: Fresh sealing reduces the chances of slips and falls by
                                            ensuring a non-slippery, even surface.
                                        </p>
                                    </div>
                                </div>
                            </div>
