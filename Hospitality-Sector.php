...
<head>
    ...
    <title>Hospitality Sector</title>
...
<body>
    ...
    <main>
        ...
        <section class="Hospitality-Sector-hero service-hero">
            <div class="container">
                <div class="text-center hero-heading">
                    <h1>
                        Hospitality Sector
                    </h1>
                    <p>Expert cleaning for exceptional hospitality</p>
                </div>
            </div>
        </section>
        <!-- hero area end here -->
        ...
        <section class="mt-100 mb-100 bath-img">
            ...
            <div class="container">
                <img src="./assets/img/sector/Hospitality-Sector.png" alt="Image not found" class="img-fluid position-relative">
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-12 col-lg-6 col-md-6 d-flex align-items-center">
                        ...
                        <div class="rs-about-detail">
                            ...
                            <h2 class="mb-30">
                                We ensure your venue shines<br> for every guest
                            </h2>
                            <h4>
                                Crafting spotless hospitality environments
                            </h4>
                            <p class="mb-30">
                                -With our specialized cleaning services, we ensure that your hospitality venue always exudes a welcoming and immaculate ambiance, meeting and exceeding the highest standards.
                            </p>
                            <p>
                            ...
                            <div class="container mt-50 mb-50">
                                <img src="./assets/img/sector/Hospitality-Sector.png" alt="Image not found" class="img-fluid bath-img-mobile">
                            </div>
                        </div>
                    </div>
