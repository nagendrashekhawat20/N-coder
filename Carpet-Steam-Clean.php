...
<body>
    ...
    <main>
        ...
        <section class="Carpet-hero service-hero">
            <div class="container">
                <div class="text-center hero-heading">
                    <h1>
                        Carpet Steam Clean
                    </h1>
                    <p>Get ready to see your carpets gleam!</p>
                </div>
            </div>
        </section>
        ...
        <section class="mt-100 mb-100 bath-img">
            ...
            <div class="container">
                <img src="./assets/img/service/carpet-bot.png" alt="Image not found" class="img-fluid position-relative">
            </div>
        </section>
                    ...
                    <div class="col-12 col-lg-6 col-md-6 d-flex align-items-center">
                        ...
                        <div class="rs-about-detail">
                            ...
                            <div class="container mt-50 mb-50">
                                <img src="./assets/img/service/carpet-bot.png" alt="Image not found" class="img-fluid bath-img-mobile">
                            </div>
                        </div>
                    </div>
