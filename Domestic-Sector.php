...
<body>
    ...
    <main>
        ...
        <section class="Domestic-Sector-hero service-hero">
            <div class="container">
                <div class="text-center hero-heading">
                    <h1>
                        Domestic Sector
                    </h1>
                    <p>A fresh start for your home</p>
                </div>
            </div>
        </section>
        <!-- hero area end here -->
        ...
        <section class="mt-100 mb-100 bath-img">
            ...
            <div class="container">
                <img src="./assets/img/sector/Domestic-Sector.png" alt="Image not found" class="img-fluid position-relative">
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-12 col-lg-6 col-md-6 d-flex align-items-center">
                        ...
                        <div class="rs-about-detail">
                            ...
                            <h2 class="mb-30">
                                Your home deserves the best cleaning care
                            </h2>
                            <h4>
                                A cleaner home, a happier you
                            </h4>
                            <p class="mb-30">
                                op Masters is your go-to solution for domestic cleaning needs. Our professional team is
                                dedicated to delivering top-notch cleaning services that transform your home into a
                                pristine and welcoming space.
                            </p>
                            <p>
                            ...
                            <div class="container mt-50 mb-50">
                                <img src="./assets/img/sector/Domestic-Sector.png" alt="Image not found" class="img-fluid bath-img-mobile">
                            </div>
                        </div>
                    </div>
