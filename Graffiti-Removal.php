...
<body>
    ...
    <main>
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-6 align-items-center top-heading d-flex">
                        ...
                        <div class="container">
                            <div class="banner-heading">
                                ...
                                <h1>
                                    Let the original beauty<br> resurface!
                                </h1>
                                <p>
                                    Soaring heights, pristine sights
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 p-0 banner-img">
                        ...
                        <div class="image-container">
                            <img src="./assets/img/service/graffti-bann.png" alt="Image not found"
        ...
        <section class="mt-100 mb-100 bath-img">
            ...
            <div class="container">
                <img src="./assets/img/service/graffti-1.png" alt="Image not found" class="img-fluid position-relative">
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-12 col-lg-6 col-md-6 d-flex align-items-center">
                        ...
                        <div class="rs-about-detail">
                            ...
                            <h2 class="mb-30">
                                Restoring surfaces to their original glory.
                            </h2>
                            <h4>
                                Where sky meets shine
                            </h4>
                            <p class="mb-30">
                                Utilizing advanced techniques and effective solutions, we meticulously remove graffiti,
                                ensuring surfaces are returned to their original state or even better.
                            </p>
                            <a href="" data-bs-target="#modalContactForm" data-bs-toggle="modal" class="btn btn-about">Get Quote</a>

                            <div class="container mt-50 mb-50">
                                <img src="./assets/img/service/high-window-1.png" alt="Image not found"
                        ...
                        <div class="detail-list-res p-4">
                            ...
                            <div>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-1">
                                        <p class="mb-0">
                                            Restored Beauty: Return surfaces to their original, pristine state, free
                                            from unsightly graffiti.
                                        </p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-1">
                                        <p class="mb-0">
                                            Deterrence: Prompt graffiti removal discourages repeated vandalism by
                                            showing regular maintenance and surveillance.
                                        </p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-1">
                                        <p class="mb-0">
                                            Surface Protection: Our techniques not only remove graffiti but also ensure
                                            the underlying surface isn't damaged or compromised.
                                        </p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-1">
                                        <p class="mb-0">
                                            Boosted Property Value: Clean, graffiti-free exteriors improve curb appeal,
