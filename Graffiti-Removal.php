...
<body>
    ...
    <main>
        ...
        <section class="Graffiti-hero service-hero">
            <div class="container">
                <div class="text-center hero-heading">
                    <h1>
                        Graffiti Removal
                    </h1>
                    <p>Let the original beauty resurface!</p>
                </div>
            </div>
        </section>
        <!-- hero area end here -->
                    ...
                    <div class="col-12 col-lg-6 col-md-6 d-flex align-items-center">
                        ...
                        <div class="rs-about-detail">
                            ...
                            <div class="container mt-50 mb-50">
                                <img src="./assets/img/service/high-window-1.png" alt="Image not found" class="img-fluid bath-img-mobile">
                            </div>
                        </div>
                    </div>
