...
<body>
    ...
    <main>
        ...
        <section class="labor-hero service-hero">
            <div class="container">
                <div class="text-center hero-heading">
                    <h1>
                    labor Hire
                    </h1>
                    <p>Efficiency and expertise at your command!</p>
                </div>
            </div>
        </section>
        <!-- hero area end here -->
        ...
        <section class="mt-100 mb-100 bath-img">
            ...
            <div class="container">
                <img src="./assets/img/service/labour-1.png" alt="Image not found" class="img-fluid position-relative">
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-12 col-lg-6 col-md-6 d-flex align-items-center">
                        ...
                        <div class="rs-about-detail">
                            ...
                            <h2 class="mb-30">
                                Maximize efficiency,<br> minimize hassle
                            </h2>
                            <h4>
                                Quality work begins with quality hands
                            </h4>
                            <p class="mb-30">
                                Drawing from a pool of trained, experienced, and dedicated professionals, we provide
                                tailored solutions to meet the specific requirements of your project, ensuring optimal
                                results and smooth operations.
                            </p>
                            <a href="" data-bs-target="#modalContactForm" data-bs-toggle="modal" class="btn btn-about">Get Quote</a>

                            <div class="container mt-50 mb-50">
                                <img src="./assets/img/service/labour-1.png" alt="Image not found" class="img-fluid bath-img-mobile">
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="detail-list-res p-4">
                            ...
                            <h4>
                                Benefits of labor hire by Top Masters:
                            </h4>
                            <div>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-1">
                                        <p class="mb-0">
                                            Flexibility: Scale your workforce as needed, adapting to project demands.
                                        </p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-1">
                                        <p class="mb-0">
                                            Expertise: Access rigorously screened and trained professionals. Cost
                                            Savings: Bypass recruitment costs and overheads.
                                            Quick Deployment: Get workers swiftly, minimizing operational delays.
                                        </p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center">
