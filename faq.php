                        ...
                        <div class="tp-main-menu tp-main-menu-three">
                            <nav id="tp-mobile-menu">
                                <ul>
                                    ...
                                    <li class="menu-item-has-children"><a href="guide.html" class="active">GUIDES</a>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-6">
                        <img src="./assets/img/about/faqs.png" alt="Image not found" class="img-fluid men-cleaning">
                        <div>
                    ...
                    <div class="accordion" id="accordionExample">
                        ...
                        <div class="accordion-item my-3">
                            <h2 class="accordion-header" id="headingFive">
                                <button class="accordion-button collapsed bg-white border-1" type="button"
                                    data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false"
                                    aria-controls="collapseFive">
                                    <b> Can I customise the cleaning service according to my specific needs?</b>
                                </button>
                            </h2>
                            <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body bg-white py-4">
                                    <p>
                                        Absolutely. We understand that every client has unique cleaning requirements. We
                                        offer customisable cleaning packages to accommodate your specific needs,
                                        ensuring that you receive a tailored cleaning service that meets your
                                        expectations.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="accordion-item my-3">
                            ...
                            <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                                ...
                                <div class="accordion-body bg-white py-4">
                                    <p>
                                        Top Master Service proudly serves the Perth area. We cover both residential and
                                        commercial properties in the region, delivering exceptional cleaning services to
                                        our valued clients.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="accordion-item my-3">
                            <h2 class="accordion-header" id="headingFive">
                                <button class="accordion-button collapsed bg-white border-1" type="button"
                                    data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false"
                                    aria-controls="collapseFive">
                                    <b>Do I need to be present during the cleaning service?</b>
                                </button>
                            </h2>
                            <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body bg-white py-4">
                                    <p>
                                        It's entirely up to you. Our professional cleaning staff is trained to work
                                        efficiently and independently. If you prefer, you can provide access to your
                                        property and go about your day while we take care of the cleaning.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item my-3">
                            <h2 class="accordion-header" id="headingFive">
                                <button class="accordion-button collapsed bg-white border-1" type="button"
                                    data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false"
                                    aria-controls="collapseFive">
                                    <b>What happens if I'm not satisfied with the cleaning service?</b>
                                </button>
                            </h2>
                            <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body bg-white py-4">
                                    <p>
                                        Your satisfaction is our priority. If you're not completely satisfied with the
                                        service provided, please contact us within 24 hours, and we will address your
                                        concerns promptly and work to resolve any issues to your satisfaction.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item my-3">
                            <h2 class="accordion-header" id="headingFive">
                                <button class="accordion-button collapsed bg-white border-1" type="button"
                                    data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false"
                                    aria-controls="collapseFive">
                                    <b>What measures do you take to ensure security and privacy?</b>
                                </button>
                            </h2>
                            <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body bg-white py-4">
                                    <p>
                                        We fully understand the gravity of security and privacy. Our cleaning staff
                                        undergoes thorough screening, and we have strict protocols in place to safeguard
                                        your property and personal information. Your trust and confidentiality are of
        ...
        <section class="mb-60">
            <div class="container">
                ...
                <div class="row justify-content-around">
                    <div class="col-lg-4 address-block pt-60 pb-60 px-5">
                        <div>
                            <h2>
                                Office Timing
                            </h2>
