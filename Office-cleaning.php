...
<body>
    ...
    <main>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-6 align-items-center d-flex">
                        ...
                        <div class="banner-heading">
                            <div class="container">
                                ...
                                <h1>
                                    We clean while<br> you excel
                                </h1>
                                <p>
                                    Inspire genius in a polished workspace
                                </p>
                            </div>
                        </div>
                        <div>
                    ...
                    <div class="col-12 col-sm-12 col-md-6">
                        <img src="./assets/img/service/office-bnner.png" alt="Image not found"
        ...
        <section class="mt-100 mb-100 bath-img">
            ...
            <div class="container">
                <img src="./assets/img/service/meeting-ofc.png" alt="Image not found"
                ...
                <div class="row">
                    <div class="col-12 col-lg-6 col-md-6 d-flex align-items-center">
                        ...
                        <div class="rs-about-detail">
                            ...
                            <a href="" class="btn btn-about" data-bs-target="#modalContactForm" data-bs-toggle="modal">Get Quote</a>
                            <div class="container">
                                <img src="./assets/img/service/cust-ofc.png" alt="Image not found"
                                                ...
                                                <div class="tp-project z-index mb-30">
                                                    <div class="tp-project-img">
                                                        <a href="./Gardening & Landscaping.php"><img
                                                                src="assets/img/service/gardening-1.png" class="img-fluid"
                                                                alt="img not found"></a>
                                                    </div>
                                                    <div class="tp-project-text">
                                                        <div class="tp-project-text-content">
