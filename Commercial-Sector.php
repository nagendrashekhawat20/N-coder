...
<body>
    ...
    <main>
        ...
        <section class="Commercial-Sector-hero service-hero">
            <div class="container">
                <div class="text-center hero-heading">
                    <h1>
                        Commercial Sector
                    </h1>
                    <p>Creating a cleaner, more productive workspace</p>
                </div>
            </div>
        </section>
        <!-- hero area end here -->
        ...
        <section class="mt-100 mb-100 bath-img">
            ...
            <div class="container">
                <img src="./assets/img/sector/Commercial-Sector.png" alt="Image not found" class="img-fluid position-relative">
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-12 col-lg-6 col-md-6 d-flex align-items-center">
                        ...
                        <div class="rs-about-detail">
                            ...
                            <h2 class="mb-30">
                                Bringing brilliance to your<br> business environment
                            </h2>
                            <h4>
                                Excellence in every corner of your workspace
                            </h4>
                            <p class="mb-30">
                                Description-Top Masters offers various commercial services to keep your workspace
                                immaculate. Our expert team is here to meet all your cleaning needs, ensuring a pristine
                            ...
                            <div class="container mt-50 mb-50">
                                <img src="./assets/img/sector/Commercial-Sector.png" alt="Image not found" class="img-fluid bath-img-mobile">
                            </div>
                        </div>
                    </div>
