...
<body>
    ...
    <section class="info-welcome">
        <div class="container">
            <p>
                Welcome to Cleaning Company of Perth City.
            </p>
        </div>
    </section>
    ...
    <main>
        ...
        <section class="Child-Sector-hero service-hero">
            <div class="container">
                <div class="text-center hero-heading">
                    <h1>
                        Child Care Sector
                    </h1>
                    <p>Prioritizing the well-being of children in clean & safe environments</p>
                </div>
            </div>
        </section>
        <!-- hero area end here -->
        ...
        <section class="mt-100 mb-100 bath-img">
            ...
            <div class="container">
                <img src="./assets/img/sector/Child-Care-Sector.png" alt="Image not found" class="img-fluid position-relative">
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-12 col-lg-6 col-md-6 d-flex align-items-center">
                        ...
                        <div class="rs-about-detail">
                            ...
                            <h2 class="mb-30">
                                We Ensure Child-Friendly<br> Spaces, Inside and Out
                            </h2>
                            <h4>
                                Creating Clean and Joyful Spaces for Kids
                            </h4>
                            <p class="mb-30">
                                Top Masters ensures that childcare centers remain immaculate and conducive to child development. Our expert cleaning services prioritize the well-being of children in a clean and safe environment.
                            </p>
                            <p>
                                Our coverage for Public Liability Insurance extends up to $20 million.
                            </p>
                            <a href="" data-bs-target="#modalContactForm" data-bs-toggle="modal" class="btn btn-about">Get Quote</a>

                            <div class="container mt-50 mb-50">
                                <img src="./assets/img/sector/Child-Care-Sector.png" alt="Image not found" class="img-fluid bath-img-mobile">
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="tp-prjects-area pt-80 pb-60">
                    <div class="service-heading">
                        ...
                        <h2>
                            Discover specialized cleaning<br> services for every sector
                        </h2>
